...
export const SubjectTasksView: React.FC<SubjectTasksViewProps> = ({
  ...
  return (
    <div className="space-y-6 pb-16 animate-in fade-in duration-200">
      ...
      <div className="glass-card p-4 sm:p-5 rounded-2xl border border-white/[0.08] grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div>
          ...
          <span className="text-[11px] text-emerald-400 font-medium tabular-nums">{completionPercentage}% completed</span>
        </div>
        ...
        <div>
          ...
          <span className="text-2xl font-bold text-zinc-200 tracking-tight tabular-nums mt-0.5 block">
            {pendingCount}
          </span>
        ...
        <div>
          ...
          <span className="text-2xl font-bold text-amber-300 tracking-tight tabular-nums mt-0.5 block">
            {dueTodayCount}
          </span>
          <span className="text-[11px] text-amber-400/80">Check lecture cutoff</span>
        </div>
        ...
        <div>
          ...
          <span className="text-2xl font-bold text-rose-300 tracking-tight tabular-nums mt-0.5 block">
            {overdueCount}
          </span>
          <span className="text-[11px] text-rose-400/80">Past official deadline</span>
        </div>
      </div>
      ...
      {filtered.length === 0 ? (
        <div className="p-12 text-center rounded-3xl glass-card border border-white/[0.08] text-zinc-400 space-y-2">
          ...
          <p className="font-semibold text-white text-base">No tasks match your filter</p>
