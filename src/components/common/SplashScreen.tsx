...
export const SplashScreen: React.FC<SplashScreenProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[99999] bg-[#08090c] flex flex-col items-center justify-center p-6 select-none overflow-hidden font-sans">
      ...
      <div className="absolute w-[360px] h-[360px] rounded-full bg-indigo-500/15 blur-[100px] pointer-events-none animate-halo-pulse" />
      ...
      <div className="relative z-10 flex flex-col items-center space-y-5 animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="w-48 sm:w-56 space-y-2 pt-2">
          <div className="h-1 w-full bg-white/[0.06] rounded-full overflow-hidden relative">
            <div className="h-full w-full bg-gradient-to-r from-indigo-500 via-violet-400 to-cyan-400 rounded-full skeleton-shimmer" />
          </div>
          <p className="text-[11px] text-zinc-400 font-mono text-center flex items-center justify-center gap-2">
